...
Voiid Countdown Timer is a simple timer plugin for Minecraft servers. Although it is simple, it can be very advanced if you know how to get the most out of it. It is compatible with **Bukkit, Spigot, Paper and forks 1.13+**. **Paper** is highly recommended due to its great performance and full compatibility.
...
- **Datapack (LITE):** Compatible with Minecraft Vanilla 1.15+ in single or multiplayer worlds. It could be considered the Lite version of VCT, without as many features as the plugin.
- **Plugin (FULL):** Compatible with Bukkit, Spigot, Paper and forks 1.13+. It can be considered the definitive version of VCT, with features that can be added over time.
...
**[RECOMMENDED!!!] VCT Docs (LITE & FULL):** https://vctdocs.mintlify.app/download

**Github (LITE & FULL):** https://github.com/Voiid-Studios/voiidcountdown/releases

**Modrinth (LITE & FULL):** https://modrinth.com/datapack/voiid-countdown-timer

**CurseForge (LITE):** https://www.curseforge.com/minecraft/data-packs/voiid-countdown-timer

**CurseForge (FULL):** https://www.curseforge.com/minecraft/bukkit-plugins/voiid-countdown-timer-for-bukkit

**SpigotMC (FULL):** https://www.spigotmc.org/resources/voiid-countdown-timer.127616/

**Hangar (FULL):** https://hangar.papermc.io/VoiidStudios/Voiid-Countdown-Timer/

<Info>
  Remember that **LITE** is where you can find the **datapack**, while **FULL** is where you can find the **plugin**.
</Info>
