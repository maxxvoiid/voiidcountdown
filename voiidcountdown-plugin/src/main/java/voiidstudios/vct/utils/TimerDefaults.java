...
public class TimerDefaults {
    ...
    public static class TimerSettings {
        ...
        public final TimerFormat format;
        public final boolean hasSound;
        public final String id;

        public TimerSettings(String text, String sound, float volume, float pitch,
                             BarColor color, BarStyle style, TimerFormat format, boolean hasSound, String id) {
            this.text = text;
            this.sound = sound;
            this.volume = volume;
            this.pitch = pitch;
